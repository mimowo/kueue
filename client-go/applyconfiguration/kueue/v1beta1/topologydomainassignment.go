...
type TopologyDomainAssignmentApplyConfiguration struct {
	Levels []TopologyDomainAssignmentLevelApplyConfiguration `json:"levels,omitempty"`
...
func (b *TopologyDomainAssignmentApplyConfiguration) WithLevels(values ...*TopologyDomainAssignmentLevelApplyConfiguration) *TopologyDomainAssignmentApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *TopologyDomainAssignmentApplyConfiguration) WithCount(value int) *TopologyDomainAssignmentApplyConfiguration {
	b.Count = &value
	return b
}
