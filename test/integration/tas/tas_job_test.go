...
var _ = ginkgo.Describe("TAS Node controller", ginkgo.Ordered, ginkgo.ContinueOnFailure, func() {
	var (
		ns           *corev1.Namespace
	...
	ginkgo.When("Nodes are created before test", func() {
		...
		ginkgo.It("should not admit workload which does not fit to the required topology domain", func() {
			...
			// This workload is inadmissible, because there is no TAS domain
		...
		ginkgo.It("should admit workload which fits in a required topology domain", func() {
			...
			ginkgo.By("creating a workload which requires rack and can fit", func() {
