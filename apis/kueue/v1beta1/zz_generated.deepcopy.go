...
func (in *TopologyDomainAssignment) DeepCopyInto(out *TopologyDomainAssignment) {
	*out = *in
	if in.Levels != nil {
		...
		*out = make([]TopologyDomainAssignmentLevel, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopologyDomainAssignmentLevel) DeepCopyInto(out *TopologyDomainAssignmentLevel) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopologyDomainAssignmentLevel.
func (in *TopologyDomainAssignmentLevel) DeepCopy() *TopologyDomainAssignmentLevel {
	if in == nil {
		return nil
	}
	out := new(TopologyDomainAssignmentLevel)
	in.DeepCopyInto(out)
	return out
}
